...
/** Does this subscription charge in the given month? Returns the day, or null. */
export function chargeDay(sub: Chargeable, year: number, month: number): number | null {
...
/** Monthly-equivalent cost, for comparing across billing cycles. */
